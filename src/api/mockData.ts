...
export const mockUsageReports: UsageReport[] = [
  {
    ...
    byDay: [
      { date: "2026-08-01", cost: 120.5, tokens: 50000, calls: 25 },
      { date: "2026-08-02", cost: 150.0, tokens: 60000, calls: 30 },
      { date: "2026-08-03", cost: 200.0, tokens: 80000, calls: 40 },
      { date: "2026-08-04", cost: 180.0, tokens: 70000, calls: 35 },
    ],
  },
  {
    id: "ur_2",
    ...
    byDay: [
      { date: "2026-08-01", cost: 60.0, tokens: 25000, calls: 15 },
      { date: "2026-08-02", cost: 75.0, tokens: 30000, calls: 20 },
    ],
  },
];
