...
// const isMockMode = import.meta.env.VITE_MOCK_MODE !== 'false';//for mock data
...
//   getUsers: () => { isMockMode ? Promise.resolve(mockApi.getUsers()) : Promise.resolve([]) },

//   getUser: (id: string) => { isMockMode ? Promise.resolve(mockApi.getUser(id)) : Promise.resolve(undefined) },

//   getUserByEmail: (email: string) => isMockMode ? Promise.resolve(mockApi.getUserByEmail(email)) : Promise.resolve(undefined),

//   addUser: (user: any) => isMockMode ? Promise.resolve(mockApi.addUser(user)) : Promise.resolve({}),

//   updateUser: (id: string, updates: any) => { isMockMode ? Promise.resolve(mockApi.updateUser(id, updates)) : Promise.resolve(undefined) },

//   deleteUser: (id: string) => isMockMode ? Promise.resolve(mockApi.deleteUser(id)) : Promise.resolve(true),

//   // Teams

//   getTeams: () => { isMockMode ? Promise.resolve(mockApi.getTeams()) : Promise.resolve([]) },

//   getTeam: (id: string) => isMockMode ? Promise.resolve(mockApi.getTeam(id)) : Promise.resolve(undefined),

//   updateTeam: (id: string, updates: any) => isMockMode ? Promise.resolve(mockApi.updateTeam(id, updates)) : Promise.resolve({}),

//   deleteTeam: (id: string) => isMockMode ? Promise.resolve(mockApi.deleteTeam(id)) : Promise.resolve(true),

//   // Providers

//   getProviders: () => isMockMode ? Promise.resolve(mockApi.getProviders()) : Promise.resolve([]),

//   getProvider: (id: string) => isMockMode ? Promise.resolve(mockApi.getProvider(id)) : Promise.resolve(undefined),

//   addProvider: (provider: any) => isMockMode ? Promise.resolve(mockApi.addProvider(provider)) : Promise.resolve({}),

//   updateProvider: (id: string, updates: any) => isMockMode ? Promise.resolve(mockApi.updateProvider(id, updates)) : Promise.resolve({}),

//   deleteProvider: (id: string) => isMockMode ? Promise.resolve(mockApi.deleteProvider(id)) : Promise.resolve(true),

//   toggleProviderStatus: (id: string) => isMockMode ? Promise.resolve(mockApi.toggleProviderStatus(id)) : Promise.resolve({}),

//   // Team-Providers

//   getTeamProviders: (teamId: string) => isMockMode ? Promise.resolve(mockApi.getTeamProviders(teamId)) : Promise.resolve([]),

//   assignProviderToTeam: (teamId: string, providerId: string, config: any) =>
//     isMockMode ? Promise.resolve(mockApi.assignProviderToTeam(teamId, providerId, config)) : Promise.resolve({}),

//   removeProviderFromTeam: (teamId: string, providerId: string) =>
//     isMockMode ? Promise.resolve(mockApi.removeProviderFromTeam(teamId, providerId)) : Promise.resolve(true),

//   toggleTeamProvider: (teamId: string, providerId: string) =>
//     isMockMode ? Promise.resolve(mockApi.toggleTeamProvider(teamId, providerId)) : Promise.resolve({}),

//   // Spend

//   getSpend: (teamId?: string) => isMockMode ? Promise.resolve(mockApi.getSpend(teamId)) : Promise.resolve([]),

//   getTeamSpendSummary: (teamId: string) =>
//     isMockMode ? Promise.resolve(mockApi.getTeamSpendSummary(teamId)) : Promise.resolve({ total: 0, byProvider: {}, dailySpend: [], count: 0 }),

//   addSpend: (spend: any) => isMockMode ? Promise.resolve(mockApi.addSpend(spend)) : Promise.resolve({}),
